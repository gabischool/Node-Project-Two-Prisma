...
import { getUserLogin, get_user, get_user_byId, register_user, update_user, user_login } from '../controllers/user.controller.js';
...
user_routers.get('/user', authenticate, getUserLogin)